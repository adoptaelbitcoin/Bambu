  ...
  return (
    <div style={{ background: "linear-gradient(135deg,#15201A,#22402F)", borderRadius: 16, padding: "18px 20px", marginBottom: 16, color: "#EDE7D2" }}>
      ...
      <div style={{ display: "flex", gap: 22, marginTop: 12, flexWrap: "wrap" }}>
        ...
        <div style={{ fontSize: 11.5, color: "#9FC4A9", alignSelf: "center", maxWidth: 260 }}>Señal medida en los puntos de inflexión históricos, resultado a 90 días. Detalle completo en la sección Backtest.</div>
      </div>
    </div>
  );
}
